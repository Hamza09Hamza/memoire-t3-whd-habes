...
% خط النصوص الإنجليزية والفرنسية (يُستخدم مع \textenglish{})
...
\usepackage{fancyhdr}
\usepackage{xcolor}
% tikz/pgfplots removed — all charts replaced with tables
\usepackage{amssymb}
\usepackage{caption}
...
% قائمة الأشكال (محذوفة — تم استبدال جميع الأشكال بجداول)
